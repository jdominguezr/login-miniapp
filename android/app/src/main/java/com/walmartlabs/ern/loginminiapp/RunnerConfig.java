package com.walmartlabs.ern.loginminiapp;

import com.walmartlabs.ern.container.miniapps.LoginMiniappActivity;
...
final class RunnerConfig {
    static final Class MAIN_MINIAPP_ACTIVITY_CLASS = LoginMiniappActivity.class;
